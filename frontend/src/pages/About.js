  ...
  return (
    <Container>
      <Card>
        ...
        <p>Ideas to start your new daily habits: read 1 page, meditate for 1 minute, take vitamins, play an instrument you want to learn for 1 min, take a 5 min walk, make your bed, 1 less coffee.</p>   
      </Card>   
    </Container>
  )
}
